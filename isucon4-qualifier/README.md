# vagrant-isucon-pass/isucon4-qualifier

## Overview

isucon4予選とほぼ同じ環境を構築して予選通過スコアまでチューニングするためのVagrantfileです。
...
- Ansibleによるプロビジョニングが完了したらスコアが表示されます
...
CentOS6環境を用意できるのであれば[ansible-isucon-pass](https://github.com/matsuu/ansible-isucon-pass)をご利用ください。
